...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    public static final String TAG = "Uxn";
    ...
    protected void onNewIntent(Intent intent) {
        ...
        try {
            ...
            Log.e(TAG, "Intent failed: " + e.getMessage());
        }
    }
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Log.v(SDLActivity.TAG, "modify thread properties failed " + e.toString());
        }
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        Log.v(SDLActivity.TAG, "Window size: " + width + "x" + height);
        Log.v(SDLActivity.TAG, "Device size: " + nDeviceWidth + "x" + nDeviceHeight);
        ...
        if (skip) {
            if (Build.VERSION.SDK_INT >= 24) {
                if (SDLActivity.mSingleton.isInMultiWindowMode()) {
                    Log.v(SDLActivity.TAG, "Don't skip in Multi-Window");
                    skip = false;
                }
            }
        }
    ...
    public boolean onKey(View  v, int keyCode, KeyEvent event) {
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            Log.v(SDLActivity.TAG, "key down: " + keyCode + ", deviceId = " + deviceId + ", source = " + source);
        } else if (event.getAction() == KeyEvent.ACTION_UP) {
            Log.v(SDLActivity.TAG, "key up: " + keyCode + ", deviceId = " + deviceId + ", source = " + source);
        }
...
class DummyEdit extends View implements View.OnKeyListener {
    ...
    @Override
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        //Log.v(SDLActivity.TAG, "onKey " + keyCode + " " + event);
        /*
